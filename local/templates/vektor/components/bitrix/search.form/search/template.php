...
<form action="<?=$arResult["FORM_ACTION"]?>" class="header-search__form">
    <input type="text" name="q" value="" size="15" maxlength="50" class="header-search__input input" placeholder="Начните вводить слово"/>
    <input name="s" class="header-search__submit" type="submit" value="
